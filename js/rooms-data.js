/* ============================================================
   Галереи номеров (язык-независимые данные).
   Текст номеров — в js/i18n.js (ключи rooms.<slug>.*).
   Порядок в массиве = порядок карточек в секции «Проживание».
   ============================================================ */
(function () {
  "use strict";
  ...
  // Полулюкс отдельной галереи на старом сайте не имел (был блоком внутри
  // страницы «Люкс») — используем подходящие кадры люкса. (TODO: заменить на
  // отдельные фото полулюкса из админки Tilda, если появятся.)
  const POLU = [
    R + "lyux/AO5A0898.jpg",
    R + "lyux/AO5A0929.jpg",
    R + "lyux/AO5A0944.jpg",
